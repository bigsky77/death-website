...
async function build(dir, conf = null, reactProductionProfiling = false, debugOutput = false, runLint = true) {
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            const { pagesDir , appDir  } = (0, _findPagesDir).findPagesDir(dir, hasAppDir);
            ...
            try {
                const [[verifyResult, typeCheckEnd]] = await Promise.all([
                    ...
                    shouldLint && nextBuildSpan.traceChild("verify-and-lint").traceAsyncFn(async ()=>{
                        var ref;
                        await (0, _verifyAndLint).verifyAndLint(dir, eslintCacheDir, (ref = config.eslint) == null ? void 0 : ref.dirs, config.experimental.cpus, config.experimental.workerThreads, telemetry, hasAppDir);
                    }), 
                ]);
