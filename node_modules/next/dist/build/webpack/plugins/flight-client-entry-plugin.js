...
class FlightClientEntryPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.afterCompile.tap(PLUGIN_NAME, (compilation)=>{
            (0, _flightManifestPlugin).traverseModules(compilation, (mod)=>{
            ...
            const recordModule = (id, mod)=>{
                ...
                if (((ref1 = mod.resourceResolveData) == null ? void 0 : (ref2 = ref1.context) == null ? void 0 : ref2.issuerLayer) === _constants.WEBPACK_LAYERS.server) {
                    return;
                }
                if (typeof id !== "undefined" && modResource) {
                    ...
                    // module ID strategy.
                    let ssrNamedModuleId = (0, _path).relative(compiler.context, modResource);
     ...
     */ const visitedBySegment = {};
        ...
        const filterClientComponents = (dependencyToFilter, inClientComponentBoundary)=>{
            ...
            const modRequest = !rawRequest.endsWith(".css") && !rawRequest.startsWith(".") && !rawRequest.startsWith("/") && !rawRequest.startsWith(_constants.APP_DIR_ALIAS) ? isFontLoader ? mod.userRequest : rawRequest : (ref3 = mod.resourceResolveData) == null ? void 0 : ref3.path;
