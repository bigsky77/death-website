        ...
        chunkGroup.chunks.forEach((chunk)=>{
            ...
            for (const mod of chunkModules){
                ...
                if (anyModule.modules) {
                    for (const subMod of anyModule.modules)callback(subMod, chunk, chunkGroup);
                }
            }
        });
    });
    ...
    createAsset(assets, compilation, context) {
        ...
        compilation.chunkGroups.forEach((chunkGroup)=>{
            ...
            function recordModule(chunk, id, mod) {
                var ref2, ref1;
                const isFontLoader = fontLoaderTargets == null ? void 0 : fontLoaderTargets.some((fontLoaderTarget)=>{
                    var ref;
                    return (ref = mod.resource) == null ? void 0 : ref.startsWith(`${fontLoaderTarget}?`);
                });
                const isCSSModule = isFontLoader || ((ref2 = mod.resource) == null ? void 0 : ref2.endsWith(".css")) || mod.type === "css/mini-extract" || !!mod.loaders && (dev ? mod.loaders.some((item)=>item.loader.includes("next-style-loader/index.js")) : mod.loaders.some((item)=>item.loader.includes("mini-css-extract-plugin/loader.js")));
