...
path , rootLayoutIncluded  }) {
     ...
     */ // When the data has not resolved yet `use` will suspend here.
        const [flightData, overrideCanonicalUrl] = (0, _react).experimental_use(childNode.data);
        ...
        (0, _react).experimental_use((0, _infinitePromise).createInfinitePromise());
    }
...
class RedirectErrorBoundary extends _react.default.Component {
    ...
    render() {
        ...
        if (redirect !== null) {
            ...
            return /*#__PURE__*/ _react.default.createElement(InfinitePromiseComponent, null);
        }
