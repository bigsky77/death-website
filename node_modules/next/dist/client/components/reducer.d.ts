...
declare function serverReducer(state: Readonly<AppRouterState>, _action: Readonly<ReloadAction | NavigateAction | RestoreAction | ServerPatchAction | PrefetchAction>): AppRouterState;
