        ...
        case ACTION_NAVIGATE:
            {
                ...
                if (!cache.data) {
                    cache.data = createRecordFromThenable((0, _appRouterClient).fetchServerResponse(url, state.tree));
                }
        ...
        case ACTION_RELOAD:
            {
                ...
                if (!cache.data) {
                    ...
                    cache.data = createRecordFromThenable((0, _appRouterClient).fetchServerResponse(new URL(href, location.origin), [
                        state.tree[0],
                        state.tree[1],
                        state.tree[2],
                        'refetch', 
