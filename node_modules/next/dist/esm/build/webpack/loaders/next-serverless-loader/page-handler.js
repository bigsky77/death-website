                ...
                if (_nextData || getStaticProps || getServerSideProps) {
                    if (renderOpts.isNotFound) {
                        ...
                        sendRenderResult({
                            req,
                            res,
                            result: result2 != null ? result2 : RenderResult.empty,
                            type: "html",
                            generateEtags,
                            poweredByHeader,
                            options: {
                        ...
                        sendRenderResult({
                            req,
                            res,
                            result: _nextData ? RenderResult.fromStatic(JSON.stringify(renderOpts.pageData)) : result != null ? result : RenderResult.empty,
