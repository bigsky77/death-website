...
import { COMPILER_NAMES, EDGE_RUNTIME_WEBPACK, FLIGHT_SERVER_CSS_MANIFEST } from "../../../shared/lib/constants";
import { traverseModules } from "./flight-manifest-plugin";
...
export class FlightClientEntryPlugin {
    ...
    apply(compiler) {
        ...
        compiler.hooks.afterCompile.tap(PLUGIN_NAME, (compilation)=>{
            ...
            const recordModule = (id, mod)=>{
                ...
                if (((ref1 = mod.resourceResolveData) == null ? void 0 : (ref2 = ref1.context) == null ? void 0 : ref2.issuerLayer) === WEBPACK_LAYERS.server) {
                    return;
                }
                if (typeof id !== "undefined" && modResource) {
                    ...
                    if (this.isEdgeServer) {
                        edgeServerModuleIds.set(ssrNamedModuleId.replace(/\/next\/dist\/esm\//, "/next/dist/"), id);
                    } else {
     ...
     */ const visitedBySegment = {};
        ...
        const filterClientComponents = (dependencyToFilter, inClientComponentBoundary)=>{
            ...
            const isFontLoader = (ref = this.fontLoaderTargets) == null ? void 0 : ref.some((fontLoaderTarget)=>mod.userRequest.startsWith(`${fontLoaderTarget}?`));
            const modRequest = !rawRequest.endsWith(".css") && !rawRequest.startsWith(".") && !rawRequest.startsWith("/") && !rawRequest.startsWith(APP_DIR_ALIAS) ? isFontLoader ? mod.userRequest : rawRequest : (ref3 = mod.resourceResolveData) == null ? void 0 : ref3.path;
