...
import { AppRouterContext, LayoutRouterContext, GlobalLayoutRouterContext } from '../../shared/lib/app-router-context';
import { ACTION_NAVIGATE, ACTION_PREFETCH, ACTION_RELOAD, ACTION_RESTORE, ACTION_SERVER_PATCH, reducer } from './reducer';
 ...
 */ export default function AppRouter({ initialTree , initialCanonicalUrl , children , hotReloader  }) {
   ...
   */ const onPopState = useCallback(({ state  })=>{
    ...
    }, /*#__PURE__*/ React.createElement(ErrorOverlay, null, // ErrorOverlay intentionally only wraps the children of app-router.
