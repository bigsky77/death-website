...
import React, { useContext, useEffect, useRef, // TODO-APP: change to React.use once it becomes stable
experimental_use as use } from 'react';
...
class RedirectErrorBoundary extends React.Component {
    ...
    render() {
        ...
        if (redirect !== null) {
            ...
            return /*#__PURE__*/ React.createElement(InfinitePromiseComponent, null);
        }
