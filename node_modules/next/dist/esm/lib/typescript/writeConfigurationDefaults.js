...
export async function writeConfigurationDefaults(ts, tsConfigPath, isFirstTimeSetup) {
    if (isFirstTimeSetup) {
    ...
    if (!("include" in rawConfig)) {
        ...
        suggestedActions.push(chalk.cyan("include") + " was set to " + chalk.bold(`['next-env.d.ts', '**/*.ts', '**/*.tsx']`));
    }
