...
export default class DevServer extends Server {
    ...
    async hasPage(pathname) {
        ...
        if (this.appDir) {
            const pageFile = await findPageFile(this.appDir, normalizedPath, this.nextConfig.pageExtensions, true);
            if (pageFile) return true;
        }
        if (this.pagesDir) {
            const pageFile = await findPageFile(this.pagesDir, normalizedPath, this.nextConfig.pageExtensions, false);
            return !!pageFile;
        }
        return false;
    }
        ...
        if (isError(err) && err.stack) {
            try {
                ...
                if (frame.lineNumber && (frame == null ? void 0 : frame.file)) {
                    ...
                    const compilation = src === COMPILER_NAMES.edgeServer ? (ref = this.hotReloader) == null ? void 0 : (ref20 = ref.edgeServerStats) == null ? void 0 : ref20.compilation : (ref21 = this.hotReloader) == null ? void 0 : (ref22 = ref21.serverStats) == null ? void 0 : ref22.compilation;
