...
async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts, isStaticGeneration = false) {
     ...
     */ const ServerComponentsRenderer = createServerComponentRenderer(()=>{
        ...
        const bodyResult = async ()=>{
            ...
            const getServerInsertedHTML = ()=>{
                const flushed = renderToString(/*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, Array.from(serverInsertedHTMLCallbacks).map((callback)=>callback())));
                return flushed;
            };
