...
export declare function calculateOverrideValues(font: string, fontMetrics: any): {
    ascent: any;
    descent: any;
    lineGap: any;
    fallbackFont: string;
};
export declare function calculateSizeAdjustValues(font: string, fontMetrics: any): {
    ascent: any;
    descent: any;
    lineGap: any;
    fallbackFont: string;
