...
class NextNodeServer extends _baseServer.default {
    ...
    getHasAppDir() {
        const appDirectory = (0, _path).join(this.dir, "app");
        return _fs.default.existsSync(appDirectory) && _fs.default.statSync(appDirectory).isDirectory();
    }
    ...
    getPagePath(pathname, locales) {
        return (0, _require).getPagePath(pathname, this.distDir, this._isLikeServerless, this.renderOpts.dev, locales, this.hasAppDir);
    }
