...
export declare function continueFromInitialStream(renderStream: ReactReadableStream, { dev, suffix, dataStream, generateStaticHTML, getServerInsertedHTML, serverInsertedHTMLToHead, polyfills, }: {
    dev?: boolean;
    suffix?: string;
